...
export const MERCHANT_DATABASE: MerchantEntry[] = [
  // Groceries
  { patterns: [/WAL-?MART(?!\s*\.?\s*COM)/i], category: 'groceries', name: 'Walmart' },
  ...
  { patterns: [/TRADER\s*JOE/i], category: 'groceries', name: "Trader Joe's" },
  { patterns: [/TJ\s*MAXX/i], category: 'shopping', name: 'TJ Maxx' },
  { patterns: [/HY-?VEE/i], category: 'groceries', name: 'Hy-Vee' },
  { patterns: [/PRICE\s*CUTTER/i], category: 'groceries', name: 'Price Cutter' },
  { patterns: [/HARTER\s*HOUSE/i], category: 'groceries', name: 'Harter House' },
  { patterns: [/WHOLE\s*FOODS/i, /WFM/i], category: 'groceries', name: 'Whole Foods' },
  { patterns: [/\bALDI\b/i], category: 'groceries', name: 'Aldi' },
  ...
  { patterns: [/CHURCH'?S\s*(CHICKEN|TEXAS)/i], category: 'dining', name: "Church's Chicken" },
  ...
  { patterns: [/HBO\s*MAX/i, /\bMAX\.COM/i], category: 'subscriptions', name: 'Max' },
  ...
  { patterns: [/PARAMOUNT\s*(\+|PLUS)/i], category: 'subscriptions', name: 'Paramount+' },
  ...
  { patterns: [/\bETSY\b/i], category: 'shopping', name: 'Etsy' },
  { patterns: [/EBAY/i], category: 'shopping', name: 'eBay' },

  // Transportation
  { patterns: [/\bUBER\b(?!\s*EATS)/i], category: 'transportation', name: 'Uber' },
  { patterns: [/LYFT/i], category: 'transportation', name: 'Lyft' },
  { patterns: [/SHELL\s*(?:OIL|SERVICE)/i, /\bSHELL\b/i], category: 'transportation', name: 'Shell' },
  { patterns: [/CHEVRON/i], category: 'transportation', name: 'Chevron' },
  { patterns: [/EXXON/i, /\bMOBIL\b/i], category: 'transportation', name: 'Exxon' },
  { patterns: [/\bBP\b|BRITISH\s*PETROL/i], category: 'transportation', name: 'BP' },
  { patterns: [/MAVERIK/i], category: 'transportation', name: 'Maverik' },
  { patterns: [/KUM\s*(?:&|AND)\s*GO/i], category: 'transportation', name: 'Kum & Go' },
  { patterns: [/CASEY'?S/i], category: 'transportation', name: "Casey's" },
  { patterns: [/MURFIN/i], category: 'transportation', name: "Murfin's" },
  { patterns: [/CONOCO/i], category: 'transportation', name: 'Conoco' },
  { patterns: [/BULLSEYE\s*#?\d/i], category: 'transportation', name: 'Bullseye' },
  ...
  { patterns: [/\bTOLL(S|WAY)?\b|E-?Z\s*PASS|TURNPIKE/i], category: 'transportation', name: 'Tolls' },

  // Utilities
  { patterns: [/COMCAST|XFINITY/i], category: 'utilities', name: 'Xfinity' },
  { patterns: [/\bAT&?T\b/i], category: 'utilities', name: 'AT&T' },
  { patterns: [/VERIZON|\bVZW\b/i], category: 'utilities', name: 'Verizon' },
  { patterns: [/T-?MOBILE/i], category: 'utilities', name: 'T-Mobile' },
  { patterns: [/\bSPRINT\b/i], category: 'utilities', name: 'Sprint' },
  { patterns: [/SPECTRUM(?!\s*HEALTH)/i], category: 'utilities', name: 'Spectrum' },
  { patterns: [/DUKE\s*ENERGY/i], category: 'utilities', name: 'Duke Energy' },
  { patterns: [/\bPG&?E\b|PACIFIC\s*GAS/i], category: 'utilities', name: 'PG&E' },
  { patterns: [/WATER\s*(?:UTIL|DEPT|BILL)/i], category: 'utilities', name: 'Water' },
  { patterns: [/GREENE\s*COUNTY\s*RESOURCE/i], category: 'utilities', name: 'County Resource Recovery' },
  { patterns: [/CITY\s*OF\s*NIXA/i], category: 'utilities', name: 'City of Nixa' },
  // "ELECTRIC" alone hits supply houses (LOYD'S ELECTRIC SUPPLY) — require
  // utility-company context.
  { patterns: [/ELECTRIC\s*(?:CO\b|COOP|UTIL|POWER|ENERGY|SERVICE|BILL)|POWER\s*CO/i], category: 'utilities', name: 'Electric' },
  ...
  // Healthcare
  { patterns: [/\bCVS\b/i], category: 'healthcare', name: 'CVS' },
  ...
  { patterns: [/UNITED\s*HEALTH/i, /\bUHC\b/i], category: 'healthcare', name: 'UnitedHealth' },
  ...
  { patterns: [/DOCTOR|DR\.\s|MEDICAL|CLINIC|HOSPITAL(?!IT)/i], category: 'healthcare', name: 'Medical' },
  { patterns: [/OPTOM|EYE\s*CARE|\bVISION\b/i], category: 'healthcare', name: 'Eye Care' },
  ...
  { patterns: [/\bSPA\b|MASSAGE/i], category: 'personal_care', name: 'Spa' },
  ...
  { patterns: [/\bZELLE\b/i], category: 'transfer', name: 'Zelle' },
  ...
  { patterns: [/\bADP\b|GUSTO|PAYCHEX/i], category: 'income_salary', name: 'Payroll' },
  ...
  { patterns: [/INTEREST\s*CHARGE|PURCHASE\s*INTEREST/i], category: 'fees', name: 'Interest Charge' },
  ...
  { patterns: [/\bBI-?LO\b/i], category: 'groceries', name: 'BI-LO' },
  ...
  { patterns: [/BURLINGTON\s*(STORES|COAT|#)/i], category: 'shopping', name: 'Burlington' },
  { patterns: [/OLD\s*NAVY/i], category: 'shopping', name: 'Old Navy' },
  { patterns: [/\bGAP\b/i], category: 'shopping', name: 'Gap' },
  { patterns: [/H\s*&\s*M\b/i], category: 'shopping', name: 'H&M' },
  { patterns: [/\bZARA\b/i], category: 'shopping', name: 'Zara' },
  { patterns: [/\bNIKE\b/i], category: 'shopping', name: 'Nike' },
  { patterns: [/\bMACY/i], category: 'shopping', name: "Macy's" },
  ...
  { patterns: [/\bTEMU\b/i], category: 'shopping', name: 'Temu' },
  { patterns: [/MENARD/i], category: 'shopping', name: 'Menards' },
  { patterns: [/ACE\s*(HDWE|HARDWARE)/i], category: 'shopping', name: 'Ace Hardware' },
  { patterns: [/FEDEX/i, /\bUPS\b/i], category: 'other', name: 'Shipping' },

  // Additional gas/convenience
  { patterns: [/\b7-?ELEVEN\b|\b7-11\b/i], category: 'transportation', name: '7-Eleven' },
  { patterns: [/SHEETZ/i], category: 'transportation', name: 'Sheetz' },
  { patterns: [/QUIKTRIP|\bQT\b/i], category: 'transportation', name: 'QuikTrip' },
  { patterns: [/PILOT\s*(TRAVEL|FLYING)/i], category: 'transportation', name: 'Pilot' },
  { patterns: [/MURPHY\s*(USA|OIL|EXPRESS|\d)/i], category: 'transportation', name: 'Murphy USA' },
  { patterns: [/SPEEDWAY/i], category: 'transportation', name: 'Speedway' },
  { patterns: [/RACETRAC(?!K)/i], category: 'transportation', name: 'RaceTrac' },
  ...
  { patterns: [/O'?\s*REILLY/i], category: 'auto', name: "O'Reilly Auto" },
  ...
  { patterns: [/\bNOTION\b/i], category: 'subscriptions', name: 'Notion' },
  { patterns: [/\bSLACK\b/i], category: 'subscriptions', name: 'Slack' },
  { patterns: [/ZOOM\s*(US|VIDEO)/i], category: 'subscriptions', name: 'Zoom' },
  { patterns: [/GITHUB/i], category: 'subscriptions', name: 'GitHub' },
  { patterns: [/\bCANVA\b/i], category: 'subscriptions', name: 'Canva' },
  { patterns: [/GODADDY/i], category: 'subscriptions', name: 'GoDaddy' },
  { patterns: [/RINGCENTRAL/i], category: 'subscriptions', name: 'RingCentral' },
  ...
  // Travel
  { patterns: [/AIRLINE|UNITED\s*AIR|DELTA\s*AIR|AMERICAN\s*AIR|SOUTHWEST\s*AIR|JETBLUE|SPIRIT\s*AIR|FRONTIER\s*AIR/i], category: 'travel', name: 'Airline' },
  { patterns: [/AIRBNB/i], category: 'travel', name: 'Airbnb' },
  { patterns: [/MARRIOTT|HILTON(?!\s*HEAD)|HYATT|HOLIDAY\s*INN|HAMPTON\s*INN/i], category: 'travel', name: 'Hotel' },
  { patterns: [/HERTZ|ENTERPRISE\s*RENT|\bAVIS\b|BUDGET\s*RENT|NATIONAL\s*CAR/i], category: 'travel', name: 'Car Rental' },

  // Pets
  { patterns: [/PETCO|PETSMART|PET\s*SUPPLIES/i], category: 'pets', name: 'Pet Store' },
  { patterns: [/\bVET\b|VETERINAR|ANIMAL\s*HOSP/i], category: 'pets', name: 'Vet' },
  { patterns: [/CHEWY/i], category: 'pets', name: 'Chewy' },

  // Education
  { patterns: [/TUITION|UNIVERSITY|COLLEGE/i], category: 'education', name: 'Education' },
  { patterns: [/STUDENT\s*LOAN|NAVIENT|NELNET|MOHELA|GREAT\s*LAKES\s*(HIGHER|EDUC|E-?PAY|STUDENT)/i], category: 'debt_payment', name: 'Student Loan' },

  // Housing
  { patterns: [/MORTGAGE|HOME\s*LOAN/i, /HOME\s*MTG|MTG\s*PYMT/i], category: 'housing', name: 'Mortgage' },
  { patterns: [/RENT\s*(?:PAY|PMT)|LANDLORD/i], category: 'housing', name: 'Rent' },
  { patterns: [/\bHOA\b|HOME\s*OWNER/i], category: 'housing', name: 'HOA' },
